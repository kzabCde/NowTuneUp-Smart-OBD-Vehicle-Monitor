...
Next Android release: **1.16.0 — Performance Insights**. See the [release notes](docs/releases/v1.16.0.md) for performance graphs, the minimal interface refresh and upgrade behavior.
