...
android {
    // Release 1.7.0: Time Slip performance testing with OBD-II, GPS and sensor fusion.
    ...
    buildTypes {
        debug {
            ...
            versionNameSuffix = "-time-slip-test"
            manifestPlaceholders["appLabel"] = "NowTuneUp Time Slip Test"
            buildConfigField("boolean", "MOCK_OBD_DEFAULT", "false")
        }
        release {
    ...
    applicationVariants.all {
        outputs.all {
            ...
            output.outputFileName = if (buildType.name == "release") {
                ...
                "NowTuneUp-v1.7.0-time-slip-test.apk"
            }
        }
    }
}
